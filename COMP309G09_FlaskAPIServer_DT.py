...
# Your API definition
app = Flask(__name__)
@app.route("/dt9", methods=['GET','POST']) #use decorator pattern for the route
def predict():
    if lr:
        try:
            json_ = request.json
...
if __name__ == '__main__':
    ...
    modelpath = "D:/CentennialWu/2020Fall/COMP309Data/GroupProject2/model_dt.pkl"
    lr = joblib.load(modelpath) # Load "model file model.pkl"
    print ('Model loaded')
    logger.info('Model loaded')
    #change to your local path
    modelcolumnpath = 'D:/CentennialWu/2020Fall/COMP309Data/GroupProject2/model_columns_dt.pkl'
    model_columns = joblib.load(modelcolumnpath) # Load "model_dt.pkl"
